...
import { clearData, getNewsApi } from '../Redux/apiReducer';
...
const News = (props) => {
    ...
    useEffect(() => {
        ...
        const updateNews = async () => {
            ...
            dispatch(getNewsApi({country:props.country,category:props.category,apiKey:props.apiKey,page:page,pageSize:props.pageSize}))
            setLoading(true)
